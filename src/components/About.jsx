...
const About = () => {
    return (
        <div className='w-full'>
            ...
            >
                <div className='md:hero-content bg-base-300/90 p-8 rounded-md hover:glass duration-300 transition-all ease-in-out hover:shadow-2xl animate-pulse hover:animate-none sticky top-1/8 z-[99] mx-4'>
                    <h2 className='text-4xl sm:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500'>
                        Neuro AI
                    </h2>
            ...
            <section className='bg-base-100 py-16'>
                <div className='max-w-6xl mx-auto px-6 md:px-12 lg:px-16'>
                    <h2 className='text-3xl sm:text-4xl font-semibold text-center mb-8 text-primary'>
                        Who We Are
                    </h2>
                    <p className='text-base sm:text-lg text-center mb-12 text-secondary'>
                    ...
                    <div className='grid gap-8 md:grid-cols-2'>
                        {[
                            ...
                            {
                                title: 'Our Vision',
                                desc: 'We aim to be at the forefront of AI research, developing technologies that improve the quality of life and contribute to global innovation. Our vision is to create a future where AI complements human potential for greater creativity and productivity.'
                            }

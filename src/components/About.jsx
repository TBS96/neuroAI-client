...
const About = () => {
    return (
        <div className='w-full'>
            ...
            >
                <div className='md:hero-content bg-base-300/90 p-8 rounded-md hover:glass duration-300 transition-all ease-in-out hover:shadow-2xl animate-pulse hover:animate-none mx-4'>
                    <h2 className='text-4xl sm:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500' data-aos='fade-up' data-aos-delay='500'>
                        Neuro AI
                    </h2>
                    <p className='text-lg sm:text-xl text-accent' data-aos='fade-down' data-aos-delay='500'>
            ...
            <section className='bg-base-100 py-16'>
                <div className='max-w-6xl mx-auto px-6 md:px-12 lg:px-16'>
                    ...
                    <p className='text-base sm:text-lg mb-12 text-secondary text-justify' data-aos='zoom-in-down'>

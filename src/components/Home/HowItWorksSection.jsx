                ...
                <div className='container mx-auto px-6 md:px-12 text-center'>
                    ...
                    <div className='mt-12 grid gap-8 md:grid-cols-3'>
                        {[
                            ...
                            return (
                                <div key={index} data-aos={aos} data-aos-delay={index * 200} className='flex flex-col items-center bg-base-300 p-6 rounded-md shadow-md hover:shadow-2xl transition-all duration-300 hover:translate-x-4 hover:cursor-pointer'>
